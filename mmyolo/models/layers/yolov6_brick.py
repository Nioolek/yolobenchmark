...
def conv_bn(in_channels, out_channels, kernel_size, stride, padding, groups=1):
    ...
    result.add_module('conv', nn.Conv2d(in_channels=in_channels, out_channels=out_channels,
                                        ...
                                        bias=False))
    result.add_module('bn', nn.BatchNorm2d(num_features=out_channels, momentum=0.03, eps=0.001))
    return result
...
class RepVGGBlock(nn.Module):
    ...
    def __init__(self, in_channels, out_channels, kernel_size=3,
        ...
        if deploy:
            ...
            self.rbr_identity = nn.BatchNorm2d(num_features=in_channels, momentum=0.03,
                                               eps=0.001) if out_channels == in_channels and stride == 1 else None
