...
from ..layers.giraffe_config import get_graph_config
from ..layers.airdet_brick import CSPLayer, ShuffleBlock
...
class GiraffeLayer(nn.Module):
    def __init__(self, feature_info, fpn_config, inner_fpn_channels, outer_fpn_channels, num_levels=5, pad_type='',
                 ...
                 separable_conv=True, redundant_bias=False, merge_type='conv'):
...
class GiraffeNeck(BaseModule):
    def __init__(self, min_level, max_level, num_levels, act_type, fpn_config, fpn_name, fpn_channels, out_fpn_channels, weight_method, depth_multiplier, width_multiplier, with_backslash, with_slash, with_skip_connect, skip_connect_type, separable_conv, feature_info, merge_type, pad_type, downsample_type, upsample_type, apply_resample_bn, conv_after_downsample, redundant_bias, conv_bn_relu_pattern, alternate_init):
        ...
        norm_layer = partial(nn.BatchNorm2d, eps=1e-3, momentum=0.03)
